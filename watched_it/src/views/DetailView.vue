    ...
    <section class="cast">
      <div class="container">
        <div class="row">
          ...
          <div class="col-2">
            <svg v-on:click="shareItem(details!.title, details!.poster)" class="share-icon" xmlns="http://www.w3.org/2000/svg"
...
export default defineComponent({
  ...
  methods: {
    shareItem(title: string, photo:string) {
      const shareData = {
        title: "WatchedIt",
        text: title,
        // url: `https://image.tmdb.org/t/p/w500/${photo}`,
...
<style lang="scss" scoped>@import "@/assets/styles/colors.scss";
@import "@/assets/styles/components/buttons.scss";
@import "@/assets/styles/pages/details.scss";</style>